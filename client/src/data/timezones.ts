/**
 * Timezone options for General Settings. IANA IDs with display label (city/region, GMT offset).
 * Kolkata (Asia/Kolkata, GMT+5:30) is default and first.
 */
...
/** Common timezones; Kolkata first as default. */
