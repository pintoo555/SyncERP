...
/** State -> cities (major cities including capital) */
export const INDIAN_STATE_CITIES: Record<string, string[]> = {
  ...
  'Tamil Nadu': ['Chennai', 'Coimbatore', 'Madurai', 'Tiruchirappalli', 'Salem', 'Tirunelveli', 'Tiruppur', 'Ranipet', 'Nagercoil', 'Thanjavur', 'Vellore', 'Kancheepuram', 'Erode', 'Tiruvannamalai', 'Pollachi', 'Rajapalayam', 'Gudiyatham', 'Pudukkottai', 'Neyveli', 'Nagapattinam', 'Viluppuram', 'Tiruchengode', 'Vaniyambadi', 'Theni', 'Udhagamandalam', 'Dindigul', 'Karur', 'Hosur', 'Kumbakonam', 'Cuddalore'],
  'Telangana': ['Hyderabad', 'Warangal', 'Nizamabad', 'Karimnagar', 'Ramagundam', 'Khammam', 'Mahbubnagar', 'Nalgonda', 'Adilabad', 'Suryapet', 'Siddipet', 'Miryalaguda', 'Sangareddy', 'Mancherial', 'Nirmal', 'Kothagudem', 'Bodhan', 'Jagtial', 'Wanaparthy', 'Nagarkurnool'],
  'Tripura': ['Agartala', 'Udaipur', 'Dharmanagar', 'Ambassa', 'Kailasahar', 'Belonia', 'Khowai', 'Teliamura', 'Bishalgarh'],
  'Uttar Pradesh': ['Lucknow', 'Kanpur', 'Ghaziabad', 'Agra', 'Varanasi', 'Meerut', 'Allahabad', 'Bareilly', 'Aligarh', 'Moradabad', 'Saharanpur', 'Gorakhpur', 'Noida', 'Firozabad', 'Jhansi', 'Muzaffarnagar', 'Mathura', 'Rampur', 'Shahjahanpur', 'Farrukhabad', 'Mau', 'Hapur', 'Etawah', 'Mirzapur', 'Bulandshahr', 'Sambhal', 'Amroha', 'Hardoi', 'Fatehpur', 'Raebareli', 'Orai', 'Sitapur', 'Bahraich', 'Modinagar', 'Unnao', 'Jaunpur', 'Lakhimpur', 'Hathras', 'Budaun', 'Faizabad', 'Azamgarh', 'Bijnor', 'Basti', 'Chandausi', 'Akbarpur', 'Ballia', 'Tanda', 'Greater Noida'],
  'Uttarakhand': ['Dehradun', 'Haridwar', 'Roorkee', 'Haldwani', 'Rudrapur', 'Kashipur', 'Rishikesh', 'Pithoragarh', 'Ramnagar', 'Mussoorie', 'Nainital', 'Almora', 'Kichha', 'Sitarganj', 'Pauri', 'Manglaur', 'Laksar', 'Tehri', 'Kotdwar', 'Vikasnagar', 'Bageshwar', 'Champawat', 'Uttarkashi', 'Bazpur', 'Lohaghat'],
  'West Bengal': ['Kolkata', 'Howrah', 'Durgapur', 'Asansol', 'Siliguri', 'Bardhaman', 'Malda', 'Baharampur', 'Habra', 'Kharagpur', 'Shantipur', 'Dankuni', 'Dhulian', 'Ranaghat', 'Haldia', 'Raiganj', 'Krishnanagar', 'Nabadwip', 'Medinipur', 'Jalpaiguri', 'Balurghat', 'Basirhat', 'Chakdaha', 'Darjeeling', 'Alipurduar', 'Purulia', 'Jangipur', 'Bankura', 'Cooch Behar', 'Tamluk', 'Serampore', 'Barasat', 'Rampurhat', 'Titagarh', 'Hugli-Chinsurah', 'Champdani', 'Bhatpara', 'Panihati', 'Kalyani', 'Bally', 'Budge Budge', 'Kanchrapara', 'Kulti', 'Madhyamgram', 'Naihati', 'Panihati', 'Baranagar', 'Uluberia', 'Rajarhat Gopalpur', 'North Barrackpur', 'North Dumdum', 'Dum Dum', 'Bidhannagar', 'New Town', 'Bidhan Nagar'],
  ...
  'Delhi': ['New Delhi', 'North Delhi', 'South Delhi', 'East Delhi', 'West Delhi', 'Central Delhi', 'Dwarka', 'Rohini', 'Saket', 'Karol Bagh', 'Paharganj', 'Connaught Place', 'Lajpat Nagar', 'Nehru Place', 'Janakpuri', 'Punjabi Bagh', 'Rajouri Garden', 'Hauz Khas', 'Vasant Kunj', 'Noida', 'Ghaziabad', 'Gurgaon', 'Faridabad'],
  'Jammu and Kashmir': ['Srinagar', 'Jammu', 'Anantnag', 'Baramulla', 'Sopore', 'Kathua', 'Udhampur', 'Kupwara', 'Budgam', 'Kulgam', 'Pulwama', 'Ganderbal', 'Bandipore', 'Samba', 'Rajouri', 'Poonch', 'Doda', 'Kishtwar', 'Ramban', 'Reasi', 'Shopian'],
...
/** Get cities for a state (or empty if state not found) */
