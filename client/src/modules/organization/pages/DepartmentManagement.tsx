...
export default function DepartmentManagement() {
  ...
  const save = () => {
    ...
    const promise = modal.open && modal.department
      ? organizationApi.updateDepartment(modal.department.id, { departmentCode: form.departmentCode.trim(), departmentName: form.departmentName.trim(), sortOrder: form.sortOrder })
      : organizationApi.createDepartment({ departmentCode: form.departmentCode.trim(), departmentName: form.departmentName.trim(), sortOrder: form.sortOrder });
    promise
  ...
  const remove = (d: OrgDepartment) => {
    ...
    setSaving(true);
    organizationApi.deleteDepartment(d.id)
      .then(() => load())
